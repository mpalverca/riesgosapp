import { FaWater, FaMountain, FaBuilding, FaFire, FaExclamationTriangle, FaHome, FaRoad, FaTree, FaMapMarkerAlt, FaBook, FaBell } from 'react-icons/fa';
...
export const cargarDatos = async () => {
    ...
    try {
        ...
        const [pointResponse, polygonResponse, cooperResponse, evinResponse, notifyResponse] = await Promise.all([
