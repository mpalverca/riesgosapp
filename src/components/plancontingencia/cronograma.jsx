...
export default function Cronograma() {
    ...
    },
    {
      ...
      horaInicio: '10h00',
      horaFin: '23H30',
      observaciones: 'Se tendrá la recepción del publico durante todo el evento'
    },
    {
      id: 3,
      fase: 'Presentaciones',
  ...
  const getFaseIcon = (fase) => {
    ...
    if (fase.includes('Reacondicionamiento')) return <BuildIcon color="action" />;
    return <ScheduleIcon />;
  };
            ...
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                ...
                <TableCell width="20%" align="center">
                  <Typography variant="subtitle2" fontWeight="bold">Fase</Typography>
                </TableCell>
                <TableCell width="15%" align="center">
                  <Typography variant="subtitle2" fontWeight="bold">Fecha</Typography>
                </TableCell>
                <TableCell width="15%" align="center">
                  <Typography variant="subtitle2" fontWeight="bold">Hora Inicio</Typography>
                </TableCell>
                <TableCell width="15%" align="center">
                  <Typography variant="subtitle2" fontWeight="bold">Hora Fin</Typography>
                </TableCell>
                <TableCell width="25%" align="center">
                  <Typography variant="subtitle2" fontWeight="bold">Observaciones</Typography>
                </TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
                ...
                <TableRow key={fase.id} hover>
                  ...
                  <TableCell>
                    <TextField
                      ...
                      size="small"
                      value={fase.fase}
                      onChange={(e) => handleCronogramaChange(fase.id, 'fase', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <TextField
                      ...
                      value={fase.fecha}
                      onChange={(e) => handleCronogramaChange(fase.id, 'fecha', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <TextField
                      ...
                      onChange={(e) => handleCronogramaChange(fase.id, 'horaInicio', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <TextField
                      ...
                      InputLabelProps={{ shrink: true }}
                      value={fase.horaFin}
                      onChange={(e) => handleCronogramaChange(fase.id, 'horaFin', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <TextField
                      ...
                      onChange={(e) => handleCronogramaChange(fase.id, 'observaciones', e.target.value)}
                    />
                  </TableCell>
                </TableRow>
              ))}
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('instalacion', 'fecha', e.target.value)}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('instalacion', 'horaInicio', e.target.value)}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('instalacion', 'horaFin', e.target.value)}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('instalacion', 'observaciones', e.target.value)}
                />
              </Grid>
            </Grid>
          </Grid>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('activacion', 'fecha', e.target.value)}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('activacion', 'horaInicio', e.target.value)}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('activacion', 'horaFin', e.target.value)}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => handlePirotecniaChange('activacion', 'observaciones', e.target.value)}
                />
              </Grid>
            </Grid>
          </Grid>
