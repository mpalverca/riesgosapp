          ...
          {/* Alerta de prototipo - Mejorada */}
            ...
            >
              <Typography variant="body2" sx={{ fontWeight: 600 }}>
                ℹ️ Sitio en fase de prototipo operativo
              </Typography>
              <Typography variant="caption" color="text.secondary">
                El sitio web de Gestión de Riesgos del GAD Loja se presenta como
                un prototipo operativo, gestionado por la Coordinación de
                Gestión de Riesgos, cuyo funcionamiento está sujeto a la
                priorización presupuestaria institucional y a la validación
                previa a su aprobación para uso oficial. Cuenta con un modelo
                conceptual y lineamientos preliminares para su implementación en
                entornos web y móvil.
              </Typography>
            </Alert>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body1" align="justify">
                  La{" "}
                  <strong>
                    Ley de Gestión de Riesgos de Desastres (LOGIRD)
                  </strong>{" "}
                  contempla la posibilidad de ocurrencia de un evento que pueda
                  afectar la economía, bienes materiales o vidas humanas.
                  <br />
                  <br />
                  La <strong>Gestión del Riesgo</strong> se refiere al proceso
                  social de planeación, ejecución, seguimiento y evaluación de
                  políticas y acciones para el conocimiento del riesgo y
                  promoción de una mayor conciencia del mismo.
                </Typography>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <Box sx={{ mt: 2 }}>
                  <Accordion elevation={1} sx={{ mb: 1, borderRadius: 2 }}>
                    ...
                    <AccordionDetails>
                      <Typography variant="body1">
                        Es el conjunto de normas, estrategias, mapas y
                        actividades que realiza una comunidad para evitar ser
                        afectada y prevenir cualquier afectación a nivel de
                        desastre. Incluye planes de contingencia, sistemas de
                        alerta temprana y programas de capacitación.
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                  ...
                  <Accordion elevation={1} sx={{ mb: 1, borderRadius: 2 }}>
                    ...
                    <AccordionDetails>
                      <Typography variant="body1">
                        Dentro de la LOGIRD, <strong>cada persona</strong>{" "}
                        dentro del territorio nacional es corresponsable. Esto
                        incluye:
                      </Typography>
                      <Box
                        sx={{
          ...
          {/* CTA Final Mejorado */}
            ...
            >
              ...
              <Typography variant="h6" sx={{ mb: 3, fontWeight: 400 }}>
                La gestión de riesgos es una responsabilidad compartida que
                requiere la participación activa de toda la sociedad.
              </Typography>
              <Button
                variant="contained"
                size="large"
